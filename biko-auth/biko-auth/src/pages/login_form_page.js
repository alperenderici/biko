...
// import {login, checkUserAuthStatus} from '../service/firebase';
...
//       const isAdmin = await checkUserAuthStatus();
...
//     //         });
//     //     }
//     //     if (user.user.email === "admin123@admin123.com") {
//     //         dispatch(loginAction(user));
//     //         navigate('/register', { 
//     //             replace: true
//     //         });
...
const LoginFormPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // const isAdmin = await checkUserAuthStatus();
    // if (isAdmin) {
    if(user.email === "admin123@admin123.com"){
