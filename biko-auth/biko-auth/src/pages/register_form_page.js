...
// import { addMachine } from '../service/firebase';
...
//     const [machineURL, setMachineId] = useState('');
...
//         const machine = await addMachine(machineName, machineSerial, machineURL);
//         // if (user) {
...
//                 <div className="text-flex md:text-2xl lg:text-3xl" style={{fontFamily: 'Nexa-Heavy', color:'#001489'}}>Register</div>
//                 <div>
